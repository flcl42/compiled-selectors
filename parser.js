...
yy: {},
symbols_: {"error":2,"start":3,"eor":4,"EOF":5,"COMMA":6,"SPACE":7,"edesc":8,"eand":9,"e":10,"ID":11,"CLASS":12,"tag":13,"NAME":14,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"COMMA",7:"SPACE",11:"ID",12:"CLASS",14:"NAME"},
productions_: [0,[3,2],[4,4],[4,1],[4,0],[8,1],[8,3],[9,1],[9,2],[10,1],[10,1],[10,1],[13,1]],
...
return parse(null, $$[$0-1]);


break;
case 2: if($$[$0-3].task=="or"){ $$[$0-3].selectors[$$[$0-3].selectors.length] = $$[$0-1]; this.$= $$[$0-3];}else this.$ = {task:"or", selectors: [$$[$0-3], $$[$0-2]]} 
break;
case 6: wh = $$[$0-2]; while(wh.where!=null)wh=wh.where; wh.where = $$[$0]; this.$= $$[$0-2];
break;
case 8: if($$[$0-1].task=="and"){ $$[$0-1].selectors[$$[$0-1].selectors.length] = $$[$01]; this.$= $$[$0-1];}else this.$ = {task:"and", selectors: [$$[$0-1], $$[$0]]} 
break;
case 9: this.$= {"task": "id", "id": $$[$0].split("#")[1], "where": null};
break;
case 10: this.$= {"task": "class", "class": $$[$0].split(".")[1], "where": null};
break;
case 11:this.$= {"task": "tag", "tag": $$[$0], "where": null};
break;
case 12:this.$=$$[$0];
break;
}
},
table: [{3:1,4:2,5:[2,4],6:[2,4],8:3,9:4,10:5,11:[1,6],12:[1,7],13:8,14:[1,9]},{1:[3]},{5:[1,10],6:[1,11]},{5:[2,3],6:[2,3],7:[1,12]},{5:[2,5],6:[2,5],7:[2,5],10:13,11:[1,6],12:[1,7],13:8,14:[1,9]},{5:[2,7],6:[2,7],7:[2,7],11:[2,7],12:[2,7],14:[2,7]},{5:[2,9],6:[2,9],7:[2,9],11:[2,9],12:[2,9],14:[2,9]},{5:[2,10],6:[2,10],7:[2,10],11:[2,10],12:[2,10],14:[2,10]},{5:[2,11],6:[2,11],7:[2,11],11:[2,11],12:[2,11],14:[2,11]},{5:[2,12],6:[2,12],7:[2,12],11:[2,12],12:[2,12],14:[2,12]},{1:[2,1]},{7:[1,14]},{9:15,10:5,11:[1,6],12:[1,7],13:8,14:[1,9]},{5:[2,8],6:[2,8],7:[2,8],11:[2,8],12:[2,8],14:[2,8]},{8:16,9:4,10:5,11:[1,6],12:[1,7],13:8,14:[1,9]},{5:[2,6],6:[2,6],7:[2,6],10:13,11:[1,6],12:[1,7],13:8,14:[1,9]},{5:[2,2],6:[2,2],7:[1,12]}],
...
rules: [/^(?:\s+)/,/^(?:[a-zA-Z_][a-zA-Z0-9-_]*)/,/^(?:[#][a-zA-Z_][a-zA-Z0-9-_]*)/,/^(?:[.][a-zA-Z_][a-zA-Z0-9-_]*)/,/^(?:,)/,/^(?:$)/,/^(?:.)/],
